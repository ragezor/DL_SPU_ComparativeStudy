...
class DeepLabv3_plus(nn.Module):
    def __init__(self, nInputChannels=1, n_classes=17, os=16, pretrained=False, freeze_bn=False, _print=True):
        if _print:
...
class DeepLabv3_plus_blender(nn.Module):
    def __init__(self, nInputChannels=1, n_classes=18, os=16, pretrained=False, freeze_bn=False, _print=True):
        if _print:
            print("Constructing DeepLabv3+ model...")
            print("Backbone: Resnet-101")
            print("Number of classes: {}".format(n_classes))
