...
sheet_withouback=wb.get_sheet(3)
...
def main(args,modelnow,datatype):
    ...
    print("len_epoch_loss_val :"+str(len(epoch_loss_val)))
    print("fail: "+str(fail))
        ...
        for datatype in ["blender"]:
            ...
            for num in ["100"]:
                ...
                if pathlist[index] in ["HiPhase", "phasenet", "deeplabv3p", "phun", "DLPU", "new_vurnet"]:
                    ...
                    if datatype == "blender":
                        dir = "H:/2022_1_5_work/work/new_blender_result/" + pathlist[
                            index] + "/blender/100blender/result/"
                    else:
