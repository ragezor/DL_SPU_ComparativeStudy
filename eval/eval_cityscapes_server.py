...
def main(args):
    ...
    for step, (images, labels, filename, filenameGt) in enumerate(loader):
        ...
        filenameSave = "./save_results/" + filename[0].split("input/")[1]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loadDir',default="D:/2022_1_5_work/work/zer/100zer/result/")
    parser.add_argument('--loadWeights', default="model_best.pth")
    parser.add_argument('--loadModel', default="erfnet.py")
    parser.add_argument('--subset', default="val")  #can be val, test, train, demoSequence
    parser.add_argument('--datadir', default= "C:/Users/Administrator/Desktop/paper/zer/")
