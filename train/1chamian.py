...
enco = True
NUM_CHANNELS = 1
NUM_CLASSES = 17# pascal=22, cityscapes=20
...
def train(args, model, enc=False):
    ...
    for epoch in range(start_epoch, args.num_epochs + 1):
        ...
        save_checkpointloss({
            ...
            'best_loss': best_loss,
            'optimizer': optimizer.state_dict(),
        }, is_best_loss, filenameCheckpointloss, filenameBestloss)
...
def save_checkpointloss(state, is_best_loss, filenameCheckpointloss, filenameBestloss):
...
def main(args):
    ...
    if (not args.state):
        ...
        # model = model_file.EESANet(imagechan=1,chann=48,numclass=NUM_CLASSES)
        # model = model_file.frrn()
        model = model_file.ERFNet1cha()  # Add decoder to encoder
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="erfnet_1cha")
    parser.add_argument('--state')

    parser.add_argument('--port', type=int, default=8097)
    parser.add_argument('--datadir', type=str, default="D:/2022_1_5_work/work/blender_data")
    parser.add_argument('--height', type=int, default=256)
    parser.add_argument('--num-epochs', type=int, default=450)
    ...
    parser.add_argument('--savedir', default="D:/2022_1_5_work/work/erfnet1cha/16/blender/100blender/")
